...
public class LoginProfActivity extends AppCompatActivity {
    ...
    private static final String TAG = "LoginProfActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextLoginEmail = findViewById(R.id.ed_log_prof_email);
        editTextLoginPass = findViewById(R.id.ed_log_prof_passe);
        progressBar = findViewById(R.id.progressbar_log_prof);
        ...
        //Login User
        Button buttonLogin = findViewById(R.id.btn_log_prof_login);
        buttonLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(email)){
                    Toast.makeText(LoginProfActivity.this,"Veuillez saisir votre email",Toast.LENGTH_LONG).show();
                    editTextLoginEmail.setError("L'email est obligatoire");
                    editTextLoginEmail.requestFocus();
                } else if (!Patterns.EMAIL_ADDRESS.matcher(email).matches()){
                    Toast.makeText(LoginProfActivity.this,"Veuillez saisir une adresse valide",Toast.LENGTH_LONG).show();
                    editTextLoginEmail.setError("L'email est invalide");
                    editTextLoginEmail.requestFocus();
                } else if (TextUtils.isEmpty(pass)){
                    Toast.makeText(LoginProfActivity.this,"Veuillez saisir votre mot de  passe",Toast.LENGTH_LONG).show();
    ...
    private void loginUser(String userEmail, String userPass) {
        authProfile.signInWithEmailAndPassword(userEmail,userPass).addOnCompleteListener(LoginProfActivity.this, new OnCompleteListener<AuthResult>() {
            @Override
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()){
                    ...
                    try {
                        ...
                        Toast.makeText(LoginProfActivity.this,e.getMessage(),Toast.LENGTH_LONG).show();
                    }
                }
    ...
    private void showAlertDialog() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(LoginProfActivity.this);
    ...
    protected void onStart() {
        ...
        if (authProfile.getCurrentUser() != null){
            Toast.makeText(LoginProfActivity.this,"Déja connecté!",Toast.LENGTH_LONG).show();
            ...
            Toast.makeText(LoginProfActivity.this,"Vous pouvez vous connecter maintenant!",Toast.LENGTH_LONG).show();
        }
    }
}