...
public class LoginEtudActivity extends AppCompatActivity {

    private String email;
    private EditText editTextLoginEmail, editTextLoginPass;
    private ProgressBar progressBar;
    private FirebaseAuth authProfile;
    private static final String TAG = "LoginEtudActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextLoginEmail = findViewById(R.id.ed_log_email);
        editTextLoginPass = findViewById(R.id.ed_log_passe);
        ...
        //Login User
        Button buttonLogin = findViewById(R.id.btn_log_login);
        buttonLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(email)){
                    Toast.makeText(LoginEtudActivity.this,"Veuillez saisir votre email",Toast.LENGTH_LONG).show();
                    editTextLoginEmail.setError("L'email est obligatoire");
                    editTextLoginEmail.requestFocus();
                } else if (!Patterns.EMAIL_ADDRESS.matcher(email).matches()){
                    Toast.makeText(LoginEtudActivity.this,"Veuillez saisir une adresse valide",Toast.LENGTH_LONG).show();
                    editTextLoginEmail.setError("L'email est invalide");
                    editTextLoginEmail.requestFocus();
                } else if (TextUtils.isEmpty(pass)){
                    Toast.makeText(LoginEtudActivity.this,"Veuillez saisir votre mot de  passe",Toast.LENGTH_LONG).show();
    ...
    private void loginUser(String userEmail, String userPass) {
        authProfile.signInWithEmailAndPassword(userEmail,userPass).addOnCompleteListener(LoginEtudActivity.this, new OnCompleteListener<AuthResult>() {
            @Override
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()){
                    Toast.makeText(LoginEtudActivity.this,"Vous êtes connecté maintenant",Toast.LENGTH_LONG).show();
                    ...
                    try {
                        ...
                        Toast.makeText(LoginEtudActivity.this,e.getMessage(),Toast.LENGTH_LONG).show();
                    }
                }
    ...
    private void showAlertDialog() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(LoginEtudActivity.this);
    ...
    protected void onStart() {
        ...
        if (authProfile.getCurrentUser() != null){
            Toast.makeText(LoginEtudActivity.this,"Déja connecté!",Toast.LENGTH_LONG).show();
            ...
            Toast.makeText(LoginEtudActivity.this,"Vous pouvez vous connecter maintenant!",Toast.LENGTH_LONG).show();
        }
    }
